...
// btnEnviar.addEventListener('click', mostrarAlerta);
...
//   formulario.setAttribute('action', 'https://formsubmit.co/lautiquiroga10@gmail.com');
//   formulario.setAttribute('method', 'POST');
//   formulario.setAttribute('name', 'contacto-portafolio');
